...
describe("Reader Context Visualization", () => {
  ...
  it("should render staged snippets with context class", async () => {
    ...
    console.log("Staged Snippet state:", JSON.stringify((result.current as any).stagedSnippets[0], null, 2));
    ...
    console.log("Start Node resolved in test:", startNode?.nodeName, "Type:", startNode?.nodeType, "Text:", startNode?.textContent);
