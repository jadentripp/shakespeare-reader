...
describe('useTTS Persistence', () => {
    ...
    beforeEach(() => {
        ...
        spies.push(spyOn(audioPlayer, 'getProgress').mockReturnValue({ currentTime: 0, duration: 0, isBuffering: false }));
        ...
        spies.push(spyOn(tauri, 'getSetting').mockImplementation((key) => {
