...
export function useProgressPersistence(options: UseProgressPersistenceOptions): UseProgressPersistenceResult {
  ...
  const scheduleSaveProgress = useCallback((page: number) => {
