...
import { CATALOG_GROUPS } from '../../lib/gutenberg'
  ...
  return (
    <section className="relative">
      <div className="flex items-end justify-between mb-8 border-b-2 border-black pb-4 dark:border-white">
        ...
        >
          <span>{showAllCategories ? 'Close Menu' : 'All Categories'}</span>
          <ChevronRight
            className={`h-4 w-4 transition-transform duration-300 ${showAllCategories ? 'rotate-90' : ''}`}
          />
        </button>
      </div>
